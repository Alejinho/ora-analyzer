...
export default class PlSqlParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterMap_order_func_declaration(ctx) {
	}

	// Exit a parse tree produced by PlSqlParser#map_order_func_declaration.
	exitMap_order_func_declaration(ctx) {
	}
	...
	enterLocal_xmlindex_clause(ctx) {
	}
